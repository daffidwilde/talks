\begin{frame}
    ...
    \begin{figure}
    \includegraphics[width=\linewidth]{no_spells_hist.pdf}
    \end{figure}
\end{frame}
...
\begin{frame}
    ...
    \begin{figure}
    \includegraphics[width=\linewidth]{los_hist.pdf}
    \end{figure}
\end{frame}
...
\begin{frame}
    ...
    \begin{figure}
    \includegraphics[width=\linewidth]{no_diag_hist.pdf}
    \end{figure}
\end{frame}
...
\begin{frame}
    ...
    \begin{figure}
    \includegraphics[width=\linewidth]{no_proc_hist.pdf}
    \end{figure}
\end{frame}
...
\begin{frame}
    ...
    \begin{figure}
    \includegraphics[width=\linewidth]{age_hist.pdf}
    \end{figure}
\end{frame}
